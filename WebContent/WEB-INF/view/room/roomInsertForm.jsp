	...
	<form action="insert.do" method="post"><!-- enctype="mulitpart/form-data" -->
		...
		<!-- 	<tr>
			...
			<tr>
				<td>침대 타입</td>
				<td>
					<input type="radio" name="bed_no" value=1 id="double"><label for="double">더블</label>
					<input type="radio" name="bed_no" value=2 id="twin"><label for="twin">트윈</label>
					<input type="radio" name="bed_no" value=3 id="ondol"><label for="ondol">온돌</label>
				</td>
			</tr>
			<tr>
				<td>객실 크기</td>
