...
<script src="${pageContext.request.contextPath}/js/intranet/intranetCommon.js"></script>

<div class="intra-main-wrap">
	<div class="intra-main-menu">
		<ul class="intra-main-menu">
			<li>
				<a href="${pageContext.request.contextPath}/intranet/mng/sales.do" style="background:#47a3da;color:#FAECC5;">
					메뉴
				</a>
			</li>
			<li>
				<a href="${pageContext.request.contextPath}/intranet/notice.do">공지사항</a>
			</li>
			<li>
