...
<div class="menu-notice-wrap">
	...
	<div class="notice-wrap">
		...
		<input type="hidden" value="${nt.ntNo}" name="no">
		<input type="hidden" value="${nt.member.mId}" name="id">
			<table>
				<tr>
					<td class='n-title'>제목</td>
					<td><input type="text" name="title" value="${nt.ntTitle}"></td>
				</tr>
				<tr>
					<td class='n-title'>내용</td>
					<td><textarea cols="60" rows="10" name="content">${nt.ntContent}</textarea></td>
				</tr>
				<tr>
					<td class='n-title'>첨부파일</td>
					<td class='df'>
						<input type="hidden" name="oldFile" value="${nt.ntFile}">
