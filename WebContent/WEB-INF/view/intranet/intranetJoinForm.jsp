...
<link href="${pageContext.request.contextPath}/css/intranet/intranetJoinForm.css" type="text/css" rel="stylesheet">
<script src="${pageContext.request.contextPath}/js/intranet/intranetJoin.js"></script>
...
<div class="join-info-wrap">
	<form action="join.do" method="post">
		<div class="join-info-form" id="form-required">
			...
			<p>
				<label>휴대전화</label>
				<input type="tel" name="phone" placeholder="ex)01012345678" maxlength="11">
				
				<br>
				
				<span class="formRule">'-'없이 숫자만 공백없이 입력</span>
				<span class="error">형식에 맞지않는 전화번호입니다.</span>
			</p>
			<p>
				<label>이메일</label>
				<input type="email" name="mail" placeholder="ex@example.com">
