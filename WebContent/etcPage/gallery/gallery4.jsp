...
<div class="gal-wrap">
	...
	<div class="gal-slide-wrap">
		<ul class="slide-title">
			...
			<li><a href="${pageContext.request.contextPath}/etcPage/gallery/gallery3.jsp">액티비티</a></li>
			<li class="cc"><a href="${pageContext.request.contextPath}/etcPage/gallery/gallery4.jsp">부대시설</a></li>
			<li><a href="${pageContext.request.contextPath}/etcPage/gallery/gallery5.jsp">기타</a></li>
		</ul>
		
		<div class="bxslider">
			<c:forEach begin="1" end="24" var="i">
				<div><img src="${pageContext.request.contextPath}/upload/gallery/sub_facilities/sub_facilities${i}.jpg"></div>
			</c:forEach>
		</div>
	</div>
</div>
