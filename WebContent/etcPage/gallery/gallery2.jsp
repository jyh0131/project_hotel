...
<div class="gal-wrap">
	...
	<div class="gal-slide-wrap">
		<ul class="slide-title">
			...
			<li class="cc"><a href="${pageContext.request.contextPath}/etcPage/gallery/gallery2.jsp">다이닝</a></li>
		...
		<div class="bxslider">
			<c:forEach begin="1" end="15" var="i">
				<div><img src="${pageContext.request.contextPath}/upload/gallery/dining/dining${i}.jpg"></div>
			</c:forEach>
		</div>
	</div>
</div>
