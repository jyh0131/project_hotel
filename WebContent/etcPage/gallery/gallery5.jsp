...
<div class="gal-wrap">
	...
	<div class="gal-slide-wrap">
		<ul class="slide-title">
			...
			<li class="cc"><a href="${pageContext.request.contextPath}/etcPage/gallery/gallery5.jsp">기타</a></li>
		</ul>
		
		<div class="bxslider">
			<c:forEach begin="1" end="5" var="i">
				<div><img src="${pageContext.request.contextPath}/upload/gallery/etc/etc${i}.jpg"></div>
			</c:forEach>
		</div>
	</div>
</div>
