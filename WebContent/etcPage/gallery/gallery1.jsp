...
<div class="gal-wrap">
	...
	<div class="gal-slide-wrap">
		<ul class="slide-title">
			<li class="cc"><a href="${pageContext.request.contextPath}/etcPage/gallery/gallery1.jsp">객실</a></li>
		...
		<div class="bxslider">
			<c:forEach begin="1" end="3" var="i">
				<div><img src="${pageContext.request.contextPath}/upload/gallery/room/room${i}.jpg"></div>
			</c:forEach>
		</div>
	</div>
</div>
